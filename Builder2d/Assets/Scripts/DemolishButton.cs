...
public class DemolishButton : MonoBehaviour
{
    ...
    private void Start()
    {
        Debug.Log(DemolishManager.Instance != null && DemolishManager.Instance.IsActive);
        Refresh(DemolishManager.Instance != null && DemolishManager.Instance.IsActive);
    }
    ...
    {
        Debug.Log(active ? activeText : idleText);

...
public class GroundBounds : MonoBehaviour
{
    ...
    private void CalculateBounds()
    {
        ...
        if (meshFilter != null && meshFilter.sharedMesh != null)
        {
            ...
            _min = center - new Vector3(worldSize.x * 0.5f, 0, worldSize.z * 0.5f);
            _max = center + new Vector3(worldSize.x * 0.5f, 0, worldSize.z * 0.5f);
        }
        else
        {
            _min = center - Vector3.one * 10f;
            _max = center + Vector3.one * 10f;
        }
    }
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        var center = new Vector3((_min.x + _max.x) * 0.5f, 0, (_min.z + _max.z) * 0.5f);
